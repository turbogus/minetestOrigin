...
runes.runes = {
	{"smith","Rune du Forgeron"},
	{"thief","Rune du Voleur"},
	{"assassin","Rune de l'Assassin"},
	{"pyromaniac","Rune du Pyromane"},
	{"necromancer","Rune du Nécromancien"},
	{"mortis_angelum","Rune de l'Ange de la Mort"},
}
...
minetest.register_node ("runes:table_empty", {
	...
	on_construct = function(pos)
		...
		meta:set_string("infotext","Viens a moi apprenti magicien...")
...
for _, row in ipairs(runes.runes) do
	...
	minetest.register_node("runes:table_"..code, {
		...
		tiles = {"table_active_top.png","table_active_bottom.png","table_active_side.png"},
		groups = {oddly_breakable_by_hand = 2},
		drawtype = "nodebox",
		paramtype = "light",
		node_box = {
