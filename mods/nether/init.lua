...
-- Nether Pearl fragment
minetest.register_craftitem("nether:nether_pearl_fragment", {
	description = "Nether Pearl fragment",
	wield_image = "nether_pearl_fragment.png",
	inventory_image = "nether_pearl_fragment.png",
	visual = "sprite",
	physical = true,
	textures = {"nether_pearl_fragment.png"},
})
...
minetest.register_craft({
	output = "nether:nether_pearl",
	recipe = {
		{"nether:nether_pearl_fragment", "nether:nether_pearl_fragment", "nether:nether_pearl_fragment"},
		{"nether:nether_pearl_fragment", "nether:nether_pearl_fragment", "nether:nether_pearl_fragment"},
		{"nether:nether_pearl_fragment", "nether:nether_pearl_fragment", "nether:nether_pearl_fragment"},
	}
})
...
-- Nether Book
-- livre magique necessaire pour créer les potions de niveau 2 ( les plus puissantes !)
-- Est une arme redoutable : tue un ennemie en 1 seul coup mais inflige des dommages à l'utilisateur ( si utiliser comme une arme )
-- Et à chaque utilisation, consomme des points d'Xp du joueur.
minetest.register_tool("nether:nether_book", {
	description = "Nether Book",
	wield_image = "nether_book.png",
	inventory_image = "nether_book.png",
	tool_capabilities = {
